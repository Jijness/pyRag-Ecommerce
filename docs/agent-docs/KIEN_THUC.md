# Kiến Thức AI Được Sử Dụng Trong `ai_service`
...
`ai_service` là service chịu trách nhiệm:
...
- logic AI trong project hiện tại là sự kết hợp giữa:
  ...
  - rule-based response generation trong [ai_service/advisor.py](D:/This%20Semester/Analysis%20and%20Design/assignment_6_ddd_marketplace/ai_service/advisor.py)

## 2. Model

Phần model chính nằm ở [ai_service/behavior_model.py](D:/This%20Semester/Analysis%20and%20Design/assignment_6_ddd_marketplace/ai_service/behavior_model.py).
...
Các feature này được tổng hợp từ nhiều service trong [ai_service/data_fetcher.py](D:/This%20Semester/Analysis%20and%20Design/assignment_6_ddd_marketplace/ai_service/data_fetcher.py), gồm:
...
- hàm `_sample_row(...)`
- file output mock: [ai_service/data/mock_behavior_training.csv](D:/This%20Semester/Analysis%20and%20Design/assignment_6_ddd_marketplace/ai_service/data/mock_behavior_training.csv)

Khi service khởi động:

- nếu đã có model bundle thì load từ [ai_service/models/behavior_bundle.joblib](D:/This%20Semester/Analysis%20and%20Design/assignment_6_ddd_marketplace/ai_service/models/behavior_bundle.joblib)
...
Knowledge base nằm trong thư mục [ai_service/kb_docs](D:/This%20Semester/Analysis%20and%20Design/assignment_6_ddd_marketplace/ai_service/kb_docs).

Các file hiện có gồm:

- [recommendation_principles.md](D:/This%20Semester/Analysis%20and%20Design/assignment_6_ddd_marketplace/ai_service/kb_docs/recommendation_principles.md)
- [coupon_and_promotion.md](D:/This%20Semester/Analysis%20and%20Design/assignment_6_ddd_marketplace/ai_service/kb_docs/coupon_and_promotion.md)
- [membership_faq.md](D:/This%20Semester/Analysis%20and%20Design/assignment_6_ddd_marketplace/ai_service/kb_docs/membership_faq.md)
- [return_policy.md](D:/This%20Semester/Analysis%20and%20Design/assignment_6_ddd_marketplace/ai_service/kb_docs/return_policy.md)
- [shipping_policy.md](D:/This%20Semester/Analysis%20and%20Design/assignment_6_ddd_marketplace/ai_service/kb_docs/shipping_policy.md)
- [cart_checkout_payment.md](D:/This%20Semester/Analysis%20and%20Design/assignment_6_ddd_marketplace/ai_service/kb_docs/cart_checkout_payment.md)
...
Phần RAG nằm ở [ai_service/kb_store.py](D:/This%20Semester/Analysis%20and%20Design/assignment_6_ddd_marketplace/ai_service/kb_store.py).
...
- [ai_service/models/kb_store.joblib](D:/This%20Semester/Analysis%20and%20Design/assignment_6_ddd_marketplace/ai_service/models/kb_store.joblib)
...
## 5. Cách `ai_service` Kết Hợp Model + KB + RAG
...
Trong [ai_service/advisor.py](D:/This%20Semester/Analysis%20and%20Design/assignment_6_ddd_marketplace/ai_service/advisor.py), sản phẩm được chấm điểm theo:
...
`ai_service` trong project hiện tại là một kiến trúc AI nhẹ, thực dụng và phù hợp với đồ án:
